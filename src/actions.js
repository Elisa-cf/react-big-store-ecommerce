...
export const GET_PRODUCTS_SUCCESS = 'GET_PRODUCTS_SUCCESS' // when we get our products and there is no error
export const GET_PRODUCTS_ERROR = 'GET_PRODUCTS_ERROR' // when there is an error
